...
public class GenericCallConsumer {
    ...
    public static void main(String[] args) throws Exception {
        //invokeViaRegistryCenter();
        invokeDirect();
    }


    public static void invokeViaRegistryCenter() throws InterruptedException {
        ApplicationConfig applicationConfig = new ApplicationConfig();
        applicationConfig.setName("generic-call-consumer");
        RegistryConfig registryConfig = new RegistryConfig();
        registryConfig.setAddress("zookeeper://118.178.254.146:2181");
        ReferenceConfig<GenericService> referenceConfig = new ReferenceConfig<>();
        referenceConfig.setInterface("org.apache.dubbo.springboot.demo.DemoService");
        ...
        invokeSayHello();
        invokeSayHelloComplex();
    }


    public static void invokeDirect() throws InterruptedException {
        ApplicationConfig applicationConfig = new ApplicationConfig();
        applicationConfig.setName("generic-call-consumer");
        RegistryConfig registryConfig = new RegistryConfig();
        //registryConfig.setAddress("zookeeper://118.178.254.146:2181");
        ReferenceConfig<GenericService> referenceConfig = new ReferenceConfig<>();
        //referenceConfig.setInterface("org.apache.dubbo.springboot.demo.DemoService");
        referenceConfig.setInterface("org.example.HelloService");
        applicationConfig.setRegistry(registryConfig);
    ...
    public static void invokeSayHelloComplex() throws InterruptedException {
        Object result = genericService.$invoke("sayHello", new String[]{"java.lang.String"}, new Object[]{"{\"name\":\"luwei\"}"});
        CountDownLatch latch = new CountDownLatch(1);
